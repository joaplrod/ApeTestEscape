...
t0 = time.time()
C2.findTarget(needleImage,0,0,width//10,height//10)
#pya.locateCenterOnScreen(needleImage)
t1 = time.time()
...
pya.dragTo(width*3//4,height/2,1)
pya.click()

t0 = time.time()
prepare_locat = C2.findTarget(needleImage, width*9//10, height*9//10,width,height)  #Image which conteins the desired image (needleImage)
t1 = time.time()
...
#pya.moveTo(1000,500,1)
pya.moveTo(width//2,height//2)

t0 = time.time()
C2.findTarget(needleImage,width*9//10, height*9//10,width,height)  #Image which contains the desired image (needleImage)
t1 = time.time()
...
needleImage = 'layerview.png'
pya.hotkey('enter')

t0 = time.time()
C2.findTarget(needleImage,width*7//10+20,height*3//10+20,width*8//10-30,height*4//10-30)  #Image which conteins the desired image (needleImage)
t1 = time.time()
...
t0 = time.time()
C2.findTarget(needleImage,width*2//10, height*7//10, width*6//10, height)
t1 = time.time()
...
pya.typewrite('benchmark.gcode')
time.sleep(0.5)
needleImage = 'ready2print.png'
pya.hotkey('enter')

t0 = time.time()
C2.findTarget(needleImage, width*9//10, height*9//10,width,height)
t1 = time.time()
print("Time to open a gcode is: ", (t1-t0))
tstep6 = t1-t0

pya.click(913,967)  #To close G-code Details popup
...
pya.typewrite('benchmark.curaproject.3mf')
time.sleep(0.5)
pya.hotkey('enter')
time.sleep(0.5)
pya.hotkey('enter')
...
t0 = time.time()
C2.findTarget(needleImage,width*9//10, height*9//10,width,height)  #Image which conteins the desired image (needleImage)
t1 = time.time()
